...
i686-elf-gcc -T link.ld -o kernel.bin -ffreestanding -O2 -nostdlib boot.o main.o common.o monitor.o interrupt.o descriptor_tables.o gdt.o isr.o timer.o kheap.o paging.o -lgcc
